...
- Pin daemonkit v0.23.0, cc-interact v0.32.1, and synckit v0.39.0, and migrate
...
### Changed
- Pin daemonkit v0.18.0, cc-interact v0.29.0, and synckit v0.35.1.
- Dispatch daemonkit's dedicated trust-verifier child from production and test
  executables, with verifier work isolated behind daemonkit-owned budgets.
...
### Fixed
- Align the plugin manifest with the immutable release tag so the exact
  tag/manifest coherence gate can publish the daemonkit v0.16 build.
...
### Fixed
- Pin the final shared release workflow, whose checksum-derived manifest
  materializes GoReleaser's direct binary assets under their exact upload
  names before draft verification.
...
[Unreleased]: https://github.com/yasyf/cc-runtime/compare/v0.18.0...HEAD
[0.18.0]: https://github.com/yasyf/cc-runtime/compare/v0.17.2...v0.18.0
[0.17.2]: https://github.com/yasyf/cc-runtime/compare/v0.17.1...v0.17.2
